...
window.selectCallback = function (variant, selector) {
  ...
  if (variant && variant.available === true) {
    $('.current_price', $product).css('display','inline');
...
window.productPage = {
  ...
  init() {
    ...
    window.productPage.enableGallery($('.product_gallery'));
    window.imageFunctions.zoomCustom('.product_gallery', false);
    setTimeout(function () {
      window.imageFunctions.linkGalleryAndCarousel($('.js-product-page-gallery .product_gallery'), $('.js-product-page-gallery .product_gallery_nav')); 
    }, 1000);
